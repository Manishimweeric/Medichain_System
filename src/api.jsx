...
export const getSupplierById = async (id) => {
  try {
    ...
    return { success: false, message: error.response?.data?.detail || 'Error fetching users by ID.' };
  }
};

export const updateSupplier = async (id, supplierData) => {
  try {
    const response = await api.put(`/users/${id}/`, supplierData);
    ...
    return { success: false, message: error.response?.data?.detail || 'An error occurred while updating the users.' };
  }
};
...
export const deleteSupplier = async (id) => {
  try {
    ...
    return { success: false, message: error.response?.data?.detail || 'An error occurred while deleting the users.' };
  }
};
...
export const approveOrder = async (requestData, id) => {
  console.log(requestData);
  try {
    const response = await api.put(`/orders/${id}/`, requestData);
